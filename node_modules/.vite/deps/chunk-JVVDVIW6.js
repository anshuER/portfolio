...
// node_modules/@react-three/fiber/dist/index-27578f8f.esm.js
  ...
  function removeChild(parentInstance, child, dispose2) {
    if (child) {
      ...
      if (shouldDispose && child.dispose && child.type !== "Scene") {
        (0, import_scheduler.unstable_scheduleCallback)(import_scheduler.unstable_IdlePriority, () => {
          try {
            child.dispose();
          } catch (e) {
          }
...
var { ReactCurrentOwner, ReactCurrentDispatcher } = (_a = React2.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) != null ? _a : {};
function useFiber() {
...
function useContextBridge() {
  ...
  while (node) {
    ...
    if (context2 && context2 !== FiberContext && !contexts.has(context2)) {
      contexts.set(context2, (_b = ReactCurrentDispatcher == null ? void 0 : ReactCurrentDispatcher.current) == null ? void 0 : _b.readContext(wrapContext(context2)));
    }
    node = node.return;
  }
...
react-reconciler/cjs/react-reconciler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-JVVDVIW6.js.map
